...
def get_latest_commit():
    response = get_url(f'https://api.github.com/repos/sonomirco/{repository}/releases/latest')
...
if latest_release_tag is None:
    ...
    requests_sent = 0
    url = f'https://api.github.com/repos/sonomirco/{repository}/commits?since=' + latest_release_tag['published_at'] + '&per_page=' + str(page_size)
